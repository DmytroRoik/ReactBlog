...
class GoogleLogin extends Component{
    ...
    render(){
        return(
            <img src="https://raw.githubusercontent.com/codegeous/sociallogin/master/src/components/social/GoogleLogin/google.png"
             title="google login" alt="google" onClick={ () => this.googleLogin() }/>
        )
    }
}
