...
class FacebookLogin extends Component{
    ...
    render(){
        return(
            <img src="https://raw.githubusercontent.com/codegeous/sociallogin/master/src/components/social/FacebookLogin/facebook.png"
             title="facebook login" alt="facebook" onClick={ () => this.facebookLogin() } />
        )
    }
}
